...
public class ProgIntegFragment extends Fragment {
    private RecyclerView proinList;

    public ProgIntegFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View d=inflater.inflate(R.layout.fragment_prog_integ, container, false);

        proinList = d.findViewById(R.id.recyclerview);
        proinList.setLayoutManager(new LinearLayoutManager(getActivity()));

        proinList.setAdapter(new CpeAdapter());
    ...
    private void initialize() {
        ...
        Call<List<Cpe>> call = service.showCpe("ProgramaIntegral");
            ...
            public void onResponse(Call<List<Cpe>> call, Response<List<Cpe>> response) {
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        CpeAdapter adapter = (CpeAdapter) proinList.getAdapter();
                        adapter.setCpe(cpe);
